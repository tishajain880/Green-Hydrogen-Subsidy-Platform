...
export const SideBar = ({ userRole, isOpen = true }) => {
  ...
  const getMenuItems = (role) => {
    ...
    const roleBasedItems = {
      GOV: [
        ...
        { icon: Shield, label: "Audit Trail", path: "/gov/audit" },
        { icon: BarChart3, label: "Analytics", path: "/gov/analytics" },
      ],
      PRODUCER: [
        { icon: FileText, label: "My Schemes", path: "/schemes" },
        { icon: FileText, label: "Browse Schemes", path: "/browse-schemes" },
      ...
      BANK: [
        ...
        { icon: FileText, label: "Settlements", path: "/bank/settlements" },
        { icon: Shield, label: "Audit Trail", path: "/audit" },
      ],
    };
