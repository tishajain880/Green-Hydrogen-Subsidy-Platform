// Use the TypeScript implementation in this file (avoid importing the legacy Login.jsx)
...
export const Login = () => {
  ...
  const [role, setRole] = useState<
    "GOV" | "PRODUCER" | "AUDITOR" | "BANK" | "MILESTONE_EDITOR"
  >();
  ...
  const demoUsers = [
    {
      ...
      desc: "Create schemes, manage producers",
    },
    {
      email: "producer@demo.in",
      role: "PRODUCER",
      name: "H₂ Producer",
      desc: "Submit milestones, track payments",
    },
    {
      email: "auditor@demo.in",
      role: "AUDITOR",
      name: "Milestone Auditor",
      desc: "Verify production claims",
    },
    {
      email: "bank@demo.in",
      role: "BANK",
    ...
    {
      email: "editor@demo.in",
      role: "MILESTONE_EDITOR",
      name: "Milestone Editor",
      desc: "Create and manage milestone templates",
    },
  ];
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="MILESTONE_EDITOR">
                      Milestone Editor
                    </SelectItem>
                  </SelectContent>
                </Select>
