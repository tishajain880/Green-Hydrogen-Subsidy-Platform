    ...
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join the future of transparent, automated subsidy disbursement. Start exploring with our interactive demo.
          </p>
      ...
      <footer className="bg-sidebar border-t border-sidebar-border px-6 py-8">
        <div className="max-w-6xl mx-auto text-center text-sidebar-foreground/70">
          <p>Built for hackathon demonstration • Ethereum Sepolia Testnet</p>
        </div>
      </footer>
    </div>
  );
